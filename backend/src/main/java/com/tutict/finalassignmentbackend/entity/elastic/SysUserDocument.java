...
public class SysUserDocument implements Serializable {
    ...
    public static SysUserDocument fromEntity(SysUser entity) {
        if (entity == null) {
            return null;
        }
        ...
        doc.setEmployeeNumber(entity.getEmployeeNumber());
        doc.setStatus(entity.getStatus());
        doc.setAccountExpiryDate(entity.getAccountExpiryDate());
        doc.setLoginFailures(entity.getLoginFailures());
        doc.setLastLoginTime(entity.getLastLoginTime());
        doc.setLastLoginIp(entity.getLastLoginIp());
        doc.setPasswordUpdateTime(entity.getPasswordUpdateTime());
    ...
    public SysUser toEntity() {
        ...
        entity.setEmployeeNumber(this.employeeNumber);
        entity.setStatus(this.status);
        entity.setAccountExpiryDate(this.accountExpiryDate);
        entity.setLoginFailures(this.loginFailures);
        entity.setLastLoginTime(this.lastLoginTime);
        entity.setLastLoginIp(this.lastLoginIp);
        entity.setPasswordUpdateTime(this.passwordUpdateTime);
