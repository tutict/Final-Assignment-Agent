class FineInformation {
  ...
  factory FineInformation.fromJson(Map<String, dynamic> json) {
    return FineInformation(
      ...
      payee: json['payee'] ?? json['handler'],
      accountNumber: json['accountNumber'] ?? json['approver'],
      bank: json['bank'] ?? json['issuingAuthority'],
  ...
  Map<String, dynamic> toJson() {
    final resolvedFineDate = fineDate ?? _parseDateTime(fineTime);
    return {
      'fineId': fineId,
      'offenseId': offenseId,
      'fineNumber': fineNumber ?? receiptNumber,
      'fineAmount': fineAmount,
      'lateFee': lateFee,
      'totalAmount': totalAmount,
      'fineDate': resolvedFineDate?.toIso8601String(),
      'paymentDeadline': paymentDeadline?.toIso8601String(),
      'issuingAuthority': issuingAuthority ?? bank,
      'handler': handler ?? payee,
      'approver': approver ?? accountNumber,
      ...
      'remarks': remarks,
      'fineTime': fineTime ?? resolvedFineDate?.toIso8601String(),
      'payee': payee,
